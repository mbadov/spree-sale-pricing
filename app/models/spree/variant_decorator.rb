Spree::Variant.class_eval do
  ...
  def put_on_sale(value, all_currencies = true, start_at = Time.now, end_at = nil, enabled = true)
    run_on_prices(all_currencies) { |p| p.put_on_sale value, start_at, end_at, enabled }
  end
